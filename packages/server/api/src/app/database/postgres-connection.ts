...
import { AddCopilotConversationTable1810000000000 } from './migration/postgres/1810000000000-AddCopilotConversationTable'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddCopilotConversationTable1810000000000,
    ]
    return migrations
}
